...
import {faEnvelope ,faBell,faComment ,faSearch,faChevronDown} from '@fortawesome/free-solid-svg-icons';
...
function HomeAd(){
 ...
 {/* {/* HEADER MOBILE*
      ...
      <div className="container-fluid">
        <div className="header-mobile-inner">
          <a className="logo" href="index.html">
            <img src={logoconv} alt="CoolAdmin" />
          </a>
  ...
  <aside className="menu-sidebar d-none d-lg-block">
    <div className="logo">
      <a href="#">
        <img  src={logoconv}  alt="Cool Admin" />
      </a>
    </div>
    <div className="menu-sidebar__content js-scrollbar1">
      <nav className="navbar-sidebar">
        <ul className="list-unstyled navbar__list">
          ...
          <li>
            <a href="form.html">
              <i className="far fa-check-square" />About Company</a>
          </li>
          <li>
            <Link to="/message">
          ...
          <li>
            <Link to="/map">
              <i className="fas fa-map-marker-alt" />Maps&Info</Link>
          </li>
